...
export function Logo() {
    return (
        <div className="pointer-events-none fixed left-4 top-4 z-50 flex items-center rounded-xl border border-white/10 bg-gray-800/60 py-2 pl-2 pr-4 shadow-2xl backdrop-blur-md">
            <img
                src="/logo.png"
                alt="Octobeat logo"
