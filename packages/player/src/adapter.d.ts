...
export type MediaPlayerListener<K extends MediaPlayerEvent> = (event: MediaPlayerEventMap[K]) => void;
export interface MediaPlayer {
     ...
     */
    on<K extends MediaPlayerEvent>(event: K, callback: MediaPlayerListener<K>): () => void;
    /**
     * Update appearance.
     */
    updateColors(options: MediaPlayerOptions): void;
    /**
     * Dispose resources.
     */
    destroy(): void;
